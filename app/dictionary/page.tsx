...
export const metadata = {
  ...
  description: 'Definitions, phonetics, and examples — a refined English dictionary experience',
}

export default function DictionaryPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7f4ef] dark:bg-[#080808] font-sans">
      ...
      <div className="fixed top-0 inset-x-0 z-50 flex justify-center px-4 pt-5 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-6xl flex items-center justify-between px-5 py-3 rounded-full border border-amber-900/10 dark:border-amber-100/10 bg-white/55 dark:bg-black/45 backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.06)]">
          ...
          <span className="text-sm tracking-[0.35em] uppercase text-amber-800/70 dark:text-amber-200/60 hidden sm:inline">
            Dictionary
          </span>
          <ThemeToggle />
        </div>
      ...
      <header className="pt-28 pb-2 px-4 text-center max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-light text-stone-900 dark:text-stone-50 tracking-tight">
          Classic Dictionary
        </h1>
        <div className="mx-auto mt-6 h-px w-24 bg-gradient-to-r from-transparent via-amber-500/60 to-transparent" />
        <p className="mt-5 text-sm text-stone-500 dark:text-stone-400 leading-relaxed max-w-md mx-auto">
          Look up any English word — meanings, pronunciation, synonyms, and real usage examples.
        </p>
      </header>
